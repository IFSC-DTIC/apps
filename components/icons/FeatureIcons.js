...
export const InformationCircleIcon = () => (
    <IconWrapper className="w-5 h-5 inline-block mr-2 shrink-0">
...
// App Icons
const AppIconContainer = ({ children, className }) => (
    <div className={`w-full h-full rounded-lg flex items-center justify-center text-white font-bold text-2xl ${className}`}>
        {children}
    </div>
);
...
export const InscricoesIcon = ({ className }) => (
...
export const RepositorioIcon = ({ className }) => (
...
export const MoodleIcon = ({ className }) => (
...
export const AIStudioIcon = ({ className }) => (
